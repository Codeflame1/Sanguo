...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SkillDataBase.getInstances(MainActivity.this).query().getCount() == 0){
            ...
            SkillDataBase.getInstances(MainActivity.this).insert("孙尚香","固有技能", "美的显现", "A", "  名传世间的绝世美人，拥有无匹的魅力，能轻易获得异性乃至同性的好感。");
            SkillDataBase.getInstances(MainActivity.this).insert("孙尚香","固有技能", "猛虎", "C", " 孙尚香流淌着江东孙氏的猛虎之血，在战斗中容易进入狂战状态，以失去理智为代价获得更高的出力，同时能够放出火焰属性的魔力。");
            SkillDataBase.getInstances(MainActivity.this).insert("孙尚香","固有技能", "兵圣传人", "D", " 孙尚香来自江东孙氏，乃是兵圣孙武之后，虽然本身不太擅长指挥,但是天赋的血脉还是赋予了他一定的统御力。");
            ...
            SkillDataBase.getInstances(MainActivity.this).insert("黄月英","宝具", "工神的无限机巧秘库", "EX", "   储藏着黄月英无数作品的宝库，拥有包括“连弩”、“木牛流马”、“机巧傀儡”等各种各样超越时代的黑科技发明——然而在黄月英眼里这些大概都是失败品吧。\n  为了追求超越人类的造物黄月英仍然在努力中，正因如此，这座名为宝库实为垃圾堆的仓库库存依旧在不断的增加。");
            ...
            SkillDataBase.getInstances(MainActivity.this).insert("黄月英","宝具", "生命创造·神性机巧", "EX", "   名为“夜夜”的神性机巧傀儡，黄月英所追求的最终造物，拥有超越人类达到物质化的完美灵魂和强大的机巧躯体，虽然只是个半成品，但二者合一还是产生了神明般的力量。\n   她是黄月英以人类之身超越神明而抵达根源的奇迹——从无到有而的创造的机巧生命体。\n    这是与人类别无二致的机巧傀儡，诞生于一次实验意外，虽然事后黄月英多次重复同样的实验，但是仍然无法再次创造生命了。");
            ...
            SkillDataBase.getInstances(MainActivity.this).insert("甄宓","固有技能", "美的显现", "A++", "  “翩若惊鸿，婉若游龙。荣曜秋菊，华茂春松。”曹植是这么描述她的美丽的。拥有卓绝的魅力，吸引他人的能力。虽然足以与貂蝉媲美，但是由于并没有美色祸乱世间的传说，所以并没有超越人与神的范畴。");
            ...
            SkillDataBase.getInstances(MainActivity.this).insert("诸葛亮(孔明)","固有技能", "空城绝技", "C", " 空城计传说的具现，诸葛亮本身力量极度虚弱时幸运会有额外的加成。");
            ...
            SkillDataBase.getInstances(MainActivity.this).insert("周瑜(公瑾)","宝具", "赤壁之业炎", "EX", "    曾经一口气燃尽七十万大军的红莲业火，是将魏武帝击下神坛的火焰。即使是神明也不敢面对这缭绕着无尽冤魂的大火，面对越多的敌人就越是强大。\n    作为释放的代价，周瑜会进入持续的虚弱状态。");
